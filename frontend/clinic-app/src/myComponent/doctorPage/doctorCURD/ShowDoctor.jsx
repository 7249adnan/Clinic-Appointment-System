...
const ShowDoctor = forwardRef((props, ref) => {
        ...
        <InputGroup className="mb-3">
          ...
          <Dropdown onSelect={handleSelect}>
            ...
            <Dropdown.Menu>
              ...
              <Dropdown.Item eventKey="specialist">Specialist</Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
          <Button
            variant="primary"
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th className="data"> Specialist </th>
                  <th className="data"> Time Slot </th>
                </tr>
              </thead>
              <tbody>
                {/* Using Object.keys() to get an array of keys */}
                {Object.keys(formdata).map((key) => (
                  <tr key={key}>
                    ...
                    <td className="data"> {formdata[key].specialist}</td>
                    <td className="data"> {formdata[key].slotTime} min </td>
                  </tr>
                ))}
              </tbody>
            </table>
